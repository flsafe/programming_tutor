...
describe "stats_sheets/new.html.erb" do
  before(:each) do
    assign(:stats_sheet, stub_model(StatsSheet,
      :syntax_checks => 1,
      :solution_checks => 1,
  ...
  it "renders new stats_sheet form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => stats_sheets_path, :method => "post" do
